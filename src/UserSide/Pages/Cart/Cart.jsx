    ...
    <Center w={"100vw"} >
          <Grid className="cart_grid" m="10" gap={5}  >
              ...
              <Button width={'full'} colorScheme='#ef506a' mr={3} onClick={onClose}>
                ...
                <Grid gap={2} mt={"10px"}>
                  {data.map((el)=>{
                    return <Flex key={el.id} justifyContent={"space-between"}  
               ...
               colorScheme='white' color={"#ef506a"} w={"80px"} h={"35px"} >Edit</Button>               
               </div>
               </div>    
               <div style={{paddingTop:"10px"}}>
                ...
                <Checkbox mt={2} defaultChecked>Support Us</Checkbox> 
                <Flex mt={2} gap={2} >
